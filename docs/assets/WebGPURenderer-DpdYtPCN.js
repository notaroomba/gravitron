import { S as E, g as A, E as p, f as ae, D as S, b as C, B as T, c as ue, d as L, h as M, w as v, i as x, j as ce, k as de, l as k, M as D, m as H, o as he, p as pe, q as z, s as F, t as w, A as le, R as fe, e as B, __tla as __tla_0 } from "./index-CfdpPrna.js";
import { l as ge, a as me } from "./colorToUniform-BXaCBwVl.js";
import { c as _e, u as be, U as xe, B as ye, G as Ge, e as Se, R as Be, t as Pe, S as Te, a as Ce, __tla as __tla_1 } from "./SharedSystems-DgC8jltR.js";
import { C as R, __tla as __tla_2 } from "./CanvasPool-DnnKikI5.js";
let Ye;
let __tla = Promise.all([
  ...
  class O {
    ...
    execute(e, t) {
      ...
      if (!t.bindGroup) {
        const u = t.textures;
        t.bindGroup = A(u.textures, u.count, s.limits.maxBatchableTextures);
      }
  ...
  class W {
    ...
    destroyAll() {
      var _a;
      for (const e in this._gpuBuffers) (_a = this._gpuBuffers[e]) == null ? void 0 : _a.destroy();
      this._gpuBuffers = {};
    }
    createGPUBuffer(e) {
    ...
    _destroyBuffer(e) {
      if (e.off("update", this.updateBuffer, this), e.off("change", this.onBufferChange, this), e.off("destroy", this.onBufferDestroy, this), !this._gpuBuffers[e.uid]) return;
    ...
    execute(e, t) {
      ...
      for (let _ = 0; _ < u.instructionSize; _++) {
        ...
        if (m.topology !== d && (d = m.topology, c.setPipelineFromGeometryProgramAndState(o.geometry, s.gpuProgram, e.state, m.topology)), s.groups[1] = m.bindGroup, !m.gpuBindGroup) {
          const P = m.textures;
          m.bindGroup = A(P.textures, P.count, this._maxTextures), m.gpuBindGroup = i.bindGroup.getBindGroup(m.bindGroup, s.gpuProgram, 1);
        }
